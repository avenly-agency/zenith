			...
			<Router>
				...
				<div className="min-h-screen font-sans text-text-main relative selection:bg-brand selection:text-white">
					...
					<div className="fixed inset-0 -z-10 pointer-events-none overflow-hidden">
						...
						/>
						{/* ZMIANA: Dodaj 'hidden md:block' do diva z szumem */}
						<div className="absolute inset-0 hidden md:block opacity-[0.03] bg-[url('https://grainy-gradients.vercel.app/noise.svg')]" />
					</div>
